...
class Acceleration:
    def __init__(self):
        ...
        self.targetTrackVelocity = [
            ...
            TrackParameter(370, 22), TrackParameter(500, MAX_VELOCITY_MS),
            TrackParameter(700, 22), TrackParameter(750, MAX_VELOCITY_MS),
            TrackParameter(980, 22), TrackParameter(1000, MAX_VELOCITY_MS),
            TrackParameter(1450, 28), TrackParameter(1550, MAX_VELOCITY_MS),
            ...
            TrackParameter(2920, 28), TrackParameter(3000, MAX_VELOCITY_MS),
